// Package egress 提供工具层网络出口治理（Phase S-9——2026-08-26 沙箱设计定案
// §9；移植蓝本 = nanobot nanobot/security/network.py，344 行 Python 的 Go 直译
// 收敛）。
//
...
// CGN + 224/4 组播 + 240/4 保留（含广播）+ v6 对应段（::/128 可能路由到本机、
// ::1、fc00::/7 ULA、fe80::/10、64:ff9b::/96 NAT64——经 IPv4 私网可达）。
// （安全审查 2026-09-06 补组播/保留/NAT64 三段。）
